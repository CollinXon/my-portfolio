...
const projects = [
...

  {
    ...
    description:
      "Greatstore is an e-commerce webapp for a bookshop where clients can choose from a list of books, add to cart and checkout items. This web app was built with React and Tailwind CSS for the front end and Timbu Api cloud for the backend where the items/products are being managed ",
...
const MyProject = () => {
  return (
    <div id="projects" className="  bg-slate-900 text-white p-6 sm:p-10  ">
      <h1 className="text-center font-bold text-lg sm:text-3xl p-10 sm:p-0">
