      ...
      >
        <nav className="p-4">
          <ul className="space-y-8 ">
            <li className='border-b-2 border-white'><a href="#" onClick={toggleMenu}>HOME</a></li>
            <li className='border-b-2 border-white'><a href="#about" onClick={toggleMenu}>ABOUT</a></li>
...
<nav className="  py-4 w-screen  bg-slate-950 border-solid border-2 border-slate-900 inline-flex justify-between sm:px-36   ">

<div className=" font-bold flex "><span className="text-white">About</span><span className="text-yellow-500">Me.</span></div>
...
<Link href="#" className=' hover:text-gray-500'>SERVICES</Link>
